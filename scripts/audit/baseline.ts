 ...
 *   - lighthouse:       lhci autorun (uses lighthouserc.cjs, static dist)
 ...
 *   - pnpm audit:       pnpm audit --prod --audit-level=low --json (the
 *                       built-in pnpm vulnerability scanner, not ours)
 *
 * Usage: pnpm check:baseline [--skip-build] [--skip=lighthouse,axe,...]
 *
