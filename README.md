...
> [`docs/tutorials/start-here.md`](./docs/development/tutorials/start-here.md), and keep the
> [glossary](./docs/development/reference/glossary.md) open for any unfamiliar term.

## Stack

New to any of these? Each links to its [glossary](./docs/development/reference/glossary.md) entry.

- [Astro](./docs/development/reference/glossary.md#astro) — the framework that builds the site into
  fast [static](./docs/development/reference/glossary.md#static-site) HTML
- [MDX](./docs/development/reference/glossary.md#mdx)
  [content collections](./docs/development/reference/glossary.md#content-collection)
  (Markdown-plus-components content) with
  [Zod](./docs/development/reference/glossary.md#zod)-validated
  [frontmatter](./docs/development/reference/glossary.md#frontmatter), so a typo fails the build
  instead of shipping
- [Tailwind](./docs/development/reference/glossary.md#tailwind) CSS v4 (via `@tailwindcss/vite`)
...
- Hosted on [Cloudflare Pages](./docs/development/reference/glossary.md#cloudflare-pages) — fully
  portable to any static host (Netlify, GitHub Pages, S3+CloudFront).
...
[`docs/tutorials/start-here.md`](./docs/development/tutorials/start-here.md) walks through this from
scratch, and the [glossary](./docs/development/reference/glossary.md) defines any unfamiliar term.
...
runs seven phases in order — `install` → `auth` → `workspace` → `env` → `repo` → `deploy` → `domain`
— saving progress so an interrupted run resumes cleanly:
...
[bootstrap reference](./docs/operations/reference/bootstrap.md); the
[first-time-setup tutorial](./docs/development/tutorials/first-time-setup.md) is the hand-held
version.
...
| `pnpm test`         | Visual-regression sweep of every page (see [`apps/site/tests/e2e/README.md`](./apps/site/tests/e2e/README.md)) |
...
[**Start here**](./docs/development/tutorials/start-here.md); for everything else, the
[docs index](./docs/README.md) lists it all. Common entry points:

- [Start here](./docs/development/tutorials/start-here.md) — the new-contributor on-ramp
- [Glossary](./docs/development/reference/glossary.md) — plain-English definitions of every tool and
  acronym
- [Add an event](./docs/product/how-to/add-an-event.md)
- [Add a project](./docs/product/how-to/add-a-project.md)
- [Edit a long-form doc](./docs/product/how-to/edit-a-long-form-doc.md)
- [Voice and tone](./docs/product/explanation/voice-and-tone.md) — read before drafting
- [Content collections reference](./docs/product/reference/content-collections.md)
...
[`docs/reference/deployment-pipeline.md`](./docs/operations/reference/deployment-pipeline.md).
...
Three workflows in [`.github/workflows/`](.github/workflows), all built on three reusable composites
...
Scope `CLOUDFLARE_API_TOKEN` to the `production` Environment (Settings → Environments) so
non-production jobs can't read it.
