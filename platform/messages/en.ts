...
export const en = {
  ...
  signIn: {
    title: 'Sign in',
    description: 'Sign in to your LVBT account with a code sent to your email.',
    heading: 'Sign in',
    intro: "We'll email you a 6-digit code. No password needed.",
    emailLabel: 'Email address',
    submit: 'Send my code',
    sending: 'Sending…',
    joinLink: 'Not a member yet? Join LVBT',
    errorSummaryHeading: 'There is a problem',
    emailError: 'Enter an email address like name@example.com',
    ...
    codeBody:
      "If {email} is on LVBT's list, we've sent it a 6-digit code. The code works for 15 minutes.",
