...
tldr: 'We run rotating audits of named stops and corridors, checking shelter, shade, lighting, sidewalks, ADA access, and frequency. Each one includes photos, a score, and before-and-after shots when a stop gets fixed.'
contacts:
