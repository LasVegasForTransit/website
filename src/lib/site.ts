...
export const site = {
  ...
  // The Week Without Driving campaign's own address. It's a separate site
  // (its own repo, its own Worker) — this project only redirects old links
  // to it. See docs/reference/week-without-driving-site.md.
  weekWithoutDriving: {
    url: 'https://lvwwd.org/',
  },
