...
- **[Node](../reference/glossary.md#node)** version 24.18.0 or newer in the 24.x line — runs the
  project. Get it from [nodejs.org](https://nodejs.org) (the "LTS" version is fine). If you use
  `nvm`, `nvm use` will follow the checked-in `.nvmrc`.
...
| ---------------------------------------- | ----------------------------------------------------------------------- | ---------------------------- |
| Add an event                             | [add-an-event.md](../../product/how-to/add-an-event.md)                 | No — it's in Google Calendar |
| Add a project                            | [add-a-project.md](../../product/how-to/add-a-project.md)               | Yes — a content file         |
| Add an initiative                        | [add-an-initiative.md](../../product/how-to/add-an-initiative.md)       | Yes — a content file         |
| Edit a long-form page (vision, mission…) | [edit-a-long-form-doc.md](../../product/how-to/edit-a-long-form-doc.md) | Yes — a content file         |
| Add transit news to Notion               | [add-transit-news.md](../../product/how-to/add-transit-news.md)         | Depends on path              |
| Use an AI assistant to help              | [work-with-ai-assistants.md](../how-to/work-with-ai-assistants.md)      | —                            |
...
[commit-messages.md](../reference/commit-messages.md) and
[git-guidelines.md](../reference/git-guidelines.md). They look strict at first; the
...
[deployment-pipeline.md](../../operations/reference/deployment-pipeline.md)). When in doubt, ask a
teammate to look before you push.
...
- [Writing docs](../reference/writing-docs.md) — if you improve these docs, keep them this
  approachable.
